...
public class ProjectController {
    ...
    public ResponseEntity<ResponseWrapper> readAll() throws TicketingProjectException {
    ...
    public ResponseEntity<ResponseWrapper> readByProjectCode(@PathVariable String projectcode) {
        ProjectDTO projectDTO = projectService.getProjectCode(projectcode);
    ...
    @DefaultExceptionMessage(defaultMessage = "Something went wrong, try again!")
    @PreAuthorize("hasAnyAuthority('Admin','Manager')")
    public ResponseEntity<ResponseWrapper> readByProjectCode(@RequestBody ProjectDTO projectDTO) throws TicketingProjectException {
    ...
    @PreAuthorize("hasAnyAuthority('Admin','Manager')")
    public ResponseEntity<ResponseWrapper> updateProject(@PathVariable String projectcode) throws TicketingProjectException {
