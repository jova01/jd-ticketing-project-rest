...
public class UserServiceImpl implements UserService {
    ...
    public UserDTO save(UserDTO dto) throws TicketingProjectException {
        ...
        User user =  mapperUtil.convertTo(dto,new User());
        user.setPassWord(passwordEncoder.encode(user.getPassWord()));

        User save = userRepository.save(user);

        return mapperUtil.convertTo(save,new UserDTO());
    ...
    public List<UserDTO> listAllByRole(String role) {
        ...
        return users.stream().map(obj -> {return mapperUtil.convertTo(obj,new UserDTO());}).collect(Collectors.toList());
    }
